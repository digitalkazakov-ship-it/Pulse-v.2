...
QUESTIONS = {
    ...
    "B2.2": "Топ ТВ-каналы по WRP/TRP — используй раздел «Медиадетали: сводка» → «TRP-рейтинг ТВ-каналов» (поле trpRanking). Для каждого бренда: какие ТВ-каналы дают наибольший охват? Покажи таблицей: строки — бренды, колонки — топ-3 канала с их TRP. Затем в «Интерпретации»: соответствует ли этот сплит задекларированной ЦА бренда (используй возрастной профиль из BHT → penetration)? Есть ли бренды, чей ТВ-сплит противоречит их аудитории?",
    "B2.3": "ТВ-спонсорство — используй раздел «Медиадетали: сводка» → «ТВ-спонсорство vs прямое ТВ-размещение». Для каждого бренда с активным спонсорством: какова доля спонсорства в ТВ-бюджете (%), на каких каналах, какую стратегическую роль оно играет (всегда-на-связи в паузах или основной инструмент)? Покажи таблицей: Бренд | Прямое ТВ TRP | Спонсорство TRP | Доля спонсорства % | Роль. Для брендов без спонсорства — отметь отдельно.",
